...
function release(version = "1.2.3"): CodexhostLatestRelease {
  return {
    ...
    releaseNotesUrl: `https://github.com/org-aio/codex-host/releases/tag/v${version}`,
    assets: [],
  };
}
        ...
        assets: [
          {
            ...
            downloadUrl:
              "https://github.com/org-aio/codex-host/releases/download/v1.2.3/codexhost-1.2.3-macos-arm64.dmg",
          },
        ],
      }),
    });
